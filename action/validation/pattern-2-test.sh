...
###############################################################################
# PATTERN 1: Hardcoded Credentials Detection Detection - Enterprise Validation Test
# Tests hardcoded-credentials-v2 on both clean and messy code
...
EXPECTED_FINDINGS_CLEAN_MIN=15
EXPECTED_FINDINGS_CLEAN_MAX=25
EXPECTED_FINDINGS_MESSY_MIN=50
EXPECTED_FINDINGS_MESSY_MAX=85
...
echo "=========================================="
echo "Pattern 2 Test: Hardcoded Credentials Detection"
echo "=========================================="
