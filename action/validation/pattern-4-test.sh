...
###############################################################################
# PATTERN 1: Unsafe Environment Access Detection Detection - Enterprise Validation Test
# Tests unsafe-env-access-v2 on both clean and messy code
...
EXPECTED_FINDINGS_CLEAN_MIN=10
EXPECTED_FINDINGS_CLEAN_MAX=20
EXPECTED_FINDINGS_MESSY_MIN=35
EXPECTED_FINDINGS_MESSY_MAX=70
...
echo "=========================================="
echo "Pattern 4 Test: Unsafe Environment Access Detection"
echo "=========================================="
