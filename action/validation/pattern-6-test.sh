...
###############################################################################
# PATTERN 1: Recursive Tool Calling Detection Detection - Enterprise Validation Test
# Tests recursive-tool-calling-v2 on both clean and messy code
...
EXPECTED_FINDINGS_CLEAN_MIN=20
EXPECTED_FINDINGS_CLEAN_MAX=35
EXPECTED_FINDINGS_MESSY_MIN=20
EXPECTED_FINDINGS_MESSY_MAX=45
...
echo "=========================================="
echo "Pattern 6 Test: Recursive Tool Calling Detection"
echo "=========================================="
