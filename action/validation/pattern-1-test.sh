...
###############################################################################
# PATTERN 1: Prompt Injection Detection - Enterprise Validation Test
# Tests pattern-1-v2 on both clean and messy code
...
EXPECTED_FINDINGS_CLEAN_MAX=30
EXPECTED_FINDINGS_MESSY_MIN=25
EXPECTED_FINDINGS_MESSY_MAX=40
...
echo "=========================================="
echo "Pattern $PATTERN_NUMBER Test: Prompt Injection"
echo "=========================================="
...
success "Pattern $PATTERN_NUMBER Test PASSED"
echo ""
