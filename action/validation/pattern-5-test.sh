...
###############################################################################
# PATTERN 1: Token Bombing Detection Detection - Enterprise Validation Test
# Tests token-bombing-v2 on both clean and messy code
...
EXPECTED_FINDINGS_CLEAN_MIN=25
EXPECTED_FINDINGS_CLEAN_MAX=45
...
echo "=========================================="
echo "Pattern 5 Test: Token Bombing Detection"
echo "=========================================="
